            ...
            for (int i = 0; i < value.Length; i++)
            {
                ...
                switch (c)
                {
                    ...
                    case (char) 159:
                        escapeChar = (byte) 'u';
                        unicode2 = (byte) (c >> 4);
                        unicode2 = (byte) (unicode2 < 10 ? unicode2 + 48 : unicode2 + 55);
                        unicode3 = (byte) (c & 0xF);
                        unicode3 = (byte) (unicode3 < 10 ? unicode3 + 48 : unicode3 + 55);
                        max += 4;
                        break;
                    ...
                    default:
                        ...
                        escapeChar = (byte) 'u';
                        unicode0 = (byte) ((c >> 12) & 0xF);
                        unicode0 = (byte) (unicode0 < 10 ? unicode0 + 48 : unicode0 + 55);

                        unicode1 = (byte) ((c >> 8) & 0xF);
                        unicode1 = (byte) (unicode1 < 10 ? unicode1 + 48 : unicode1 + 55);

                        unicode2 = (byte) ((c >> 4) & 0xF);
                        unicode2 = (byte) (unicode2 < 10 ? unicode2 + 48 : unicode2 + 55);
                ...
                buffer[offset++] = unicode0;
                buffer[offset++] = unicode1;
                buffer[offset++] = unicode2;
                buffer[offset++] = unicode3;
            }
